...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "TAG My Devices", // Be sure to change this for your skill.
            "HELP_MESSAGE": "Do you want to insure this device. Respond with the number of the answer. " +
            "For example, say one for yes, two for no, say, start. ",
            "REPEAT_QUESTION_MESSAGE": "To repeat the last question, say, repeat. ",
            "ASK_MESSAGE_START": "Would you like to insure this device?",
            "HELP_REPROMPT": "To give an answer to a question, respond with the number of the answer. ",
            "STOP_MESSAGE": "Would you like to proceed with your insurance?",
            "CANCEL_MESSAGE": "Ok, let\'s continue again soon.",
            "NO_MESSAGE": "Ok, Goodbye!",
            "TRIVIA_UNHANDLED": "Try saying a number",
            "HELP_UNHANDLED": "Say yes to continue, or no to end the process.",
            "START_UNHANDLED": "Say start to start a new insurance quote.",
            "NEW_GAME_MESSAGE": "Welcome to %s. ",
            "WELCOME_MESSAGE": "Do you want to insure this device. Respond with yes or no " +
            "Let\'s begin. ",
            "ANSWER_CORRECT_MESSAGE": "correct. ",
            "ANSWER_WRONG_MESSAGE": "wrong. ",
            "CORRECT_ANSWER_MESSAGE": "The quote is %s %s ",
            "ANSWER_IS_MESSAGE": "That quote  is ",
            "TELL_QUESTION_MESSAGE": "Question %s. %s ",
            "GAME_OVER_MESSAGE": "You got %s as the quote. Thank you!",
            "SCORE_IS_MESSAGE": "Your quote is %s. "
        }
    },
    "en-US": {
        "translation": {
    ...
    "en-GB": {
        "translation": {
            ...
            "GAME_NAME" : "CDL Insurance Quote Service" // Be sure to change this for your skill.
        }
    },
    "de": {
        "translation": {
