...
module.exports = {
    ...
    "QUESTIONS_EN_GB" : [
        {
            "would you be using this device in your current address?": [
                "yes",
                "no",
                "i would like to change to a new address",
                "i would like to update it in the future",
                "not now"

            ]
        },
        {
            "would you like to add this device to your existing house insurance for a small increase in the premium? ": [
                "yes",
                "no",
                "I would like to insure this device seperately",
                "i would like to update it in the future",
                "not now"
            ]
        },
        {
            "would you like to insure this device in an auto renewal plan?": [
                "yes",
                "no",
                "remind me to look for alternate quotes 30 days before renewal",
                "i would like to update it in the future",
                "not now"
            ]
        },
